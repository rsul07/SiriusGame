...
<template>
  <div class="flex items-end justify-center gap-4 text-center">
    ...
    <div v-if="leaders[0]" class="order-1 flex flex-col items-center">
      <div class="relative">
        <img :src="resolveAvatarUrl(leaders[0].avatarUrl)" alt="1st place" class="w-24 h-24 rounded-full border-4 border-yellow-400 object-cover bg-gray-200">
    ...
    <div v-if="leaders[1]" class="order-2 flex flex-col items-center">
      <img :src="resolveAvatarUrl(leaders[1].avatarUrl)" alt="2nd place" class="w-20 h-20 rounded-full border-4 border-gray-300 object-cover bg-gray-200">
    ...
    <div v-if="leaders[2]" class="order-3 flex flex-col items-center">
      <img :src="resolveAvatarUrl(leaders[2].avatarUrl)" alt="3rd place" class="w-16 h-16 rounded-full border-4 border-yellow-600 object-cover bg-gray-200">
