...
<template>
  <div class="p-4">
    <!-- Шапка только для уведомлений, невидима для потока -->
    <div class="fixed top-0 right-0 z-20 h-16 flex items-center justify-end px-4 pointer-events-none">
      <div ref="notificationArea" class="relative pointer-events-auto">
    ...
    <div>
      <!-- Приветственный блок с нужными отступами -->
      <div class="flex flex-col items-center justify-center pt-16 mb-8">
      ...
      <div v-else class="max-w-7xl mx-auto">
        <h2 class="text-xl font-bold mb-4">Текущие мероприятия</h2>
